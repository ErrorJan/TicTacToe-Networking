namespace TicTacToe
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // ipInput
            // 
            ipInput.Font = new Font("Microsoft Sans Serif", 11.25F, FontStyle.Bold, GraphicsUnit.Point);
            ipInput.Location = new Point(250, 140);
            ipInput.Name = "ipInput";
            ipInput.Size = new Size(112, 39);
            ipInput.TabIndex = 4;
            ipInput.Text = "IP Eingabe";
            ipInput.UseVisualStyleBackColor = true;
            ipInput.Click += button2_Click;
            // 
            // Form1
            // 
